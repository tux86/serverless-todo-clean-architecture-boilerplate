import { generatePrefixedResourceName, generatePrefixedSsmParameterName, varToString } from '../../common/serverless'
import { AWSResource, AWSResourceSet } from '../../common/serverless/types'
