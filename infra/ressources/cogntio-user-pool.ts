import { generatePrefixedResourceName, generatePrefixedSsmParameterName, varToString } from '../../common/src/aws'
import { AWSResource, AWSResourceSet } from '../../common/src/aws/types'
